...
@section('title', 'Modifier Entraîneur - Lyon Palme')
    ...
    <div class="container" style="max-width: 800px; margin: 0 auto; padding: 2rem 1.5rem;">
        ...
        <div style="margin-bottom: 2rem;">
            ...
            <p style="color: var(--text-muted);">
                Modifiez les informations de {{ $entraineur->prenom }} {{ $entraineur->nom }}
            </p>
        </div>

        <div class="card">
            <form method="POST" action="{{ route('entraineurs.update', $entraineur) }}">
                @csrf
                @method('PUT')
                ...
                <div style="display: grid; gap: 1.5rem;">
                    ...
                    <div>
                        ...
                        <input type="text" id="nom" name="nom" value="{{ old('nom', $entraineur->nom) }}" 
                    ...
                    <div>
                        ...
                        <input type="text" id="prenom" name="prenom" value="{{ old('prenom', $entraineur->prenom) }}" 
                    ...
                    <div>
                        ...
                        <input type="text" id="role" name="role" value="{{ old('role', $entraineur->role) }}" 
                    ...
                    <div>
                        ...
                        <input type="text" id="login" name="login" value="{{ old('login', $entraineur->login) }}" 
                    ...
                    <div>
                        ...
                        <small style="color: var(--text-muted); font-size: 0.875rem; margin-top: 0.25rem; display: block;">
                            Laissez vide pour conserver le mot de passe actuel. Minimum 6 caractères si modifié.
                        </small>
                        @error('mot_de_passe')
                            <span style="color: var(--danger); font-size: 0.875rem; margin-top: 0.25rem; display: block;">{{ $message }}</span>
                        @enderror
                ...
                <div style="display: flex; gap: 1rem; margin-top: 2rem; padding-top: 2rem; border-top: 2px solid var(--border);">
                    <a href="{{ route('entraineurs.show', $entraineur) }}" class="button button-secondary">
                        Annuler
                    </a>
